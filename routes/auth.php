...
Route::middleware('guest:web,admin,doctor,ray_employee,laboratorie_employee,patient')->group(function () {
...
Route::middleware('auth:web,admin,doctor,ray_employee,laboratorie_employee,patient')->group(function () {
