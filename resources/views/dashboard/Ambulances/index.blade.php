						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <a href="{{route('admin.dashboard.ambulance.create')}}" class="btn btn-primary">اضافة سيارة جديدة</a>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        @foreach($ambulances as $ambulance)
											<tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.dashboard.ambulance.edit',$ambulance->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
