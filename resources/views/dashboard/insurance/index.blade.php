        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('admin.dashboard.insurance.create')}}" class="btn btn-primary">{{trans('insurance.Add_Insurance')}}</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap text-center" id="example1">
                            ...
                            @foreach($insurances as $insurance)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.dashboard.insurance.edit',$insurance->id)}}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
