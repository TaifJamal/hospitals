...
{{--                                                         <td>{{$patient_ray->employee->name ?? 'noEmployee'}}</td>--}}
                                                            ...
                                                            @if($patient_ray->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{route('doctor.dashboard.invoices.show',$patient_ray->id)}}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>
                                                    ...
                                                    @foreach($patient_Laboratories as $patient_Laboratorie)
                                                        <tr>
                                                            ...
                                                            @if($patient_Laboratorie->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{route('doctor.dashboard.laboratories.show',$patient_Laboratorie->id)}}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>
