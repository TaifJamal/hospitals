    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('admin.dashboard.sections.index') }}">{{trans('main-sidebar_trans.view_all')}}</a></li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('admin.dashboard.doctors.index') }}">{{trans('main-sidebar_trans.view_all')}}</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @php
                        ...
                        $route='admin.dashboard.Add_GroupServices.'.$currentLocale;
                    @endphp
                    <li><a class="slide-item" href="{{ route('admin.dashboard.service.index') }}">{{trans('main-sidebar_trans.Single_service')}}</a></li>
                    <li><a class="slide-item" href="{{ route($route) }}">{{trans('main-sidebar_trans.group_services')}}</a></li>
                    <li><a class="slide-item" href="{{ route('admin.dashboard.insurance.index') }}">{{trans('main-sidebar_trans.Insurance')}}</a></li>
                    <li><a class="slide-item" href="{{ route('admin.dashboard.ambulance.index') }}">{{trans('main-sidebar_trans.ambulance')}}</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('admin.dashboard.patients.create')}}">اضافة مريض</a></li>
                    <li><a class="slide-item" href="{{ route('admin.dashboard.patients.index') }}">قائمة المرضي</a></li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    @php
                        $currentLocale = app()->getLocale();
                        $RouteSingleInvoices='admin.dashboard.single_invoices.'.$currentLocale;
                    @endphp
                    <li><a class="slide-item" href="{{ route($RouteSingleInvoices) }}">فاتورة خدمة مفردة</a></li>
                     @php
                        $currentLocale = app()->getLocale();
                        $RouteGroupInvoices='admin.dashboard.group_invoices.'.$currentLocale;
                    @endphp
                    <li><a class="slide-item" href="{{ route($RouteGroupInvoices) }}">فاتورة خدمة مجمعة</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('admin.dashboard.receipt.index') }}">سند قبض</a></li>
                    <li><a class="slide-item" href="{{ route('admin.dashboard.payment.index') }}">سند صرف</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('admin.dashboard.ray_employee.index') }}">قائمة الموظفين</a></li>
                </ul>
            </li>
            <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('admin.dashboard.laboratorie_employee.index') }}">قائمة الموظفين</a></li>
            </ul>
            </li>
